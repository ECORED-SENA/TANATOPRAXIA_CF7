  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal
      .titulo-principal__numero
        span 3
      h1 Naturaleza y propósito del embalsamamiento
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.color-secundario.p-5.text-center
        ...
        h2.cst Desinfección
        p.cst Es el primer momento de la tanatopraxia. Este procedimiento se encuentra orientado a la eliminación de microorganismos que causan enfermedades en los humanos. En el proceso de embalsamamiento se podrá distinguir dos tipos de desinfección:  1. De insumos e instrumentos y 2.  Del cadáver.
        p.cst Debido a la desinfección se puede salvaguardar la integridad y el bienestar de las personas que intervienen en el servicio funerario.
    ...
    .row.justify-content-center.mb-5
      .col-lg-1
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cp.mb-4
        figure
          img(src='@/assets/curso/t3/f6.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Tener y comprender el certificado de defunción.
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cac.mb-4
        figure
          img(src='@/assets/curso/t3/f7.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Manipular todos los cuerpos con la premisa universal de bioseguridad.
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cp.mb-4
        figure
          img(src='@/assets/curso/t3/f8.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Comprender los requerimientos de la estética del cadáver.
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cac.mb-4
        figure
          img(src='@/assets/curso/t3/f9.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Identificación y marcación del fallecido con nombres y apellidos completos. 
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cp.mb-4
        figure
          img(src='@/assets/curso/t3/f10.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Inventario de las prendas u objetos que trae y se entregan para el fallecido.
      .col-lg-1
      .col-lg-1
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cac.mb-4
        figure
          img(src='@/assets/curso/t3/f11.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Revisar las condiciones externas del fallecido ¿cuál fue la causa de la muerte?
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cp.mb-4
        figure
          img(src='@/assets/curso/t3/f12.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Tiempo aproximado del servicio funerario, porque el lugar y el destino influyen en el cuerpo sin vida. 
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cac.mb-4
        figure
          img(src='@/assets/curso/t3/f13.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Identificación de las características del cuerpo. 
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cp.mb-4
        figure
          img(src='@/assets/curso/t3/f14.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Escoger punto de inyección y drenaje. 
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cac.mb-4
        figure
          img(src='@/assets/curso/t3/f15.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Determinar la presión y el flujo de la máquina inyectora del líquido que ingresa al cuerpo.
      .col-lg-1
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cp.mb-4
        figure
          img(src='@/assets/curso/t3/f16.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Reconocimiento y acomodación de las posiciones físicas del cadáver. 
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cp.mb-4
        figure
          img(src='@/assets/curso/t3/f17.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Selección de métodos para cerrar la boca y los ojos. 
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cac.mb-4
        figure
          img(src='@/assets/curso/t3/f18.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Evaluar la alternativa en caso de que se salgan de control las medidas tomadas. 
      .col-lg-2.col-md-3.boxShadow.p-4.bb.bb--cp.mb-4
        figure
          img(src='@/assets/curso/t3/f19.svg', alt='icono relacionado').w85px.mb-4
        p.text-small.text-center Reconocimiento de tratamientos complementarios que se pueden hacer con el cadáver.
