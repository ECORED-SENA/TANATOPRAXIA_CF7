...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-5 Para realizar el tratamiento de la cavidad primero se debe de contar con instrumentos tales como: hidroaspirador, aspirador eléctrico, bomba manual o máquina de presión de aire, trocar, tubo y aspirador nasal.  La aspiración de la cavidad toracoabdominal y pélvica se debe realizar mediante la división topográfica, ya que esta ayuda al embalsamador a realizar una ubicación aproximada de los órganos, la cual permite realizar el tratamiento de cavidad necesario según las condiciones presentadas por el cadáver.
    ...
    .row.mb-5
      .col-lg-4
        figure
          img(src='@/assets/curso/t6/f11.png', alt='Imagen relacionada')
      .col-lg-8
